...
public class InvoicePrintServiceImplGst extends InvoicePrintServiceImpl{
	@Inject
	public InvoicePrintServiceImplGst(InvoiceRepository invoiceRepo, AccountConfigRepository accountConfigRepo) {
